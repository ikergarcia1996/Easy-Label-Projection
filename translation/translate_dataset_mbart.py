...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Source language id. See: https://huggingface.co/facebook/mbart-large-50-many-to-many-mmt",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Target language id. See: https://huggingface.co/facebook/mbart-large-50-many-to-many-mmt",
    )
